...
// INCLUDE_git_commit_h__ :: 

git_commit_create_options :: struct {
	version: c.uint,
...
*/
git_commit_create_cb :: proc "c" (^git_oid, ^git_signature, ^git_signature, cstring, cstring, ^git_tree, c.int, ^^git_commit, rawptr) -> c.int

/** An array of commits returned from the library */
git_commitarray :: struct {
	commits: ^^git_commit,
	count:   c.int,
}
...
foreign lib {
	...
	*/
	git_commit_lookup :: proc(commit: ^^git_commit, repo: ^git_repository, id: ^git_oid) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_commit_lookup_prefix :: proc(commit: ^^git_commit, repo: ^git_repository, id: ^git_oid, len: c.int) -> c.int ---
	...
	*/
	git_commit_owner :: proc(commit: ^git_commit) -> ^git_repository ---
	...
	*/
	git_commit_message_encoding :: proc(commit: ^git_commit) -> cstring ---
	...
	*/
	git_commit_body :: proc(commit: ^git_commit) -> cstring ---
	...
	*/
	git_commit_time :: proc(commit: ^git_commit) -> git_time_t ---
	...
	*/
	git_commit_time_offset :: proc(commit: ^git_commit) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_commit_committer_with_mailmap :: proc(out: ^^git_signature, commit: ^git_commit, mailmap: ^git_mailmap) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_commit_author_with_mailmap :: proc(out: ^^git_signature, commit: ^git_commit, mailmap: ^git_mailmap) -> c.int ---
	...
	*/
	git_commit_raw_header :: proc(commit: ^git_commit) -> cstring ---
	...
	* @return 0 or an error code
	*/
	git_commit_tree :: proc(tree_out: ^^git_tree, commit: ^git_commit) -> c.int ---
	...
	*/
	git_commit_tree_id :: proc(commit: ^git_commit) -> ^git_oid ---
	...
	*/
	git_commit_parent_id :: proc(commit: ^git_commit, n: c.uint) -> ^git_oid ---
	...
	* or an error code
	*/
	git_commit_nth_gen_ancestor :: proc(ancestor: ^^git_commit, commit: ^git_commit, n: c.uint) -> c.int ---
	...
	* or an error code
	*/
	git_commit_header_field :: proc(out: ^git_buf, commit: ^git_commit, field: cstring) -> c.int ---
	...
	*/
	git_commit_extract_signature :: proc(signature: ^git_buf, signed_data: ^git_buf, repo: ^git_repository, commit_id: ^git_oid, field: cstring) -> c.int ---
	...
	*/
	git_commit_create :: proc(id: ^git_oid, repo: ^git_repository, update_ref: cstring, author: ^git_signature, committer: ^git_signature, message_encoding: cstring, message: cstring, tree: ^git_tree, parent_count: c.int, parents: []^git_commit) -> c.int ---
	...
	*	the given reference will be updated to point to it
	*/
	git_commit_create_v :: proc(id: ^git_oid, repo: ^git_repository, update_ref: cstring, author: ^git_signature, committer: ^git_signature, message_encoding: cstring, message: cstring, tree: ^git_tree, parent_count: c.int, #c_vararg _: ..any) -> c.int ---
	...
	*/
	git_commit_create_from_stage :: proc(id: ^git_oid, repo: ^git_repository, message: cstring, opts: ^git_commit_create_options) -> c.int ---
	...
	*	the given reference will be updated to point to it
	*/
	git_commit_amend :: proc(id: ^git_oid, commit_to_amend: ^git_commit, update_ref: cstring, author: ^git_signature, committer: ^git_signature, message_encoding: cstring, message: cstring, tree: ^git_tree) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_commit_create_buffer :: proc(out: ^git_buf, repo: ^git_repository, author: ^git_signature, committer: ^git_signature, message_encoding: cstring, message: cstring, tree: ^git_tree, parent_count: c.int, parents: []^git_commit) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_commit_create_with_signature :: proc(out: ^git_oid, repo: ^git_repository, commit_content: cstring, signature: cstring, signature_field: cstring) -> c.int ---
	...
	* @return 0
	*/
	git_commit_dup :: proc(out: ^^git_commit, source: ^git_commit) -> c.int ---
	...
	*/
	git_commitarray_dispose :: proc(array: ^git_commitarray) ---
}
