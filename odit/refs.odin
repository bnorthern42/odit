...
*/
git_reference_foreach_cb :: proc "c" (^git_reference, rawptr) -> c.int
...
* @return non-zero to terminate the iteration
*/
git_reference_foreach_name_cb :: proc "c" (cstring, rawptr) -> c.int

/**
* Normalization options for reference lookup
*/
git_reference_format_t :: enum c.uint {
	/**
...
foreign lib {
	...
	*/
	git_reference_lookup :: proc(out: ^^git_reference, repo: ^git_repository, name: cstring) -> c.int ---
	...
	*/
	git_reference_dwim :: proc(out: ^^git_reference, repo: ^git_repository, shorthand: cstring) -> c.int ---
	...
	*/
	git_reference_symbolic_create_matching :: proc(out: ^^git_reference, repo: ^git_repository, name: cstring, target: cstring, force: c.int, current_value: cstring, log_message: cstring) -> c.int ---
	...
	*/
	git_reference_symbolic_create :: proc(out: ^^git_reference, repo: ^git_repository, name: cstring, target: cstring, force: c.int, log_message: cstring) -> c.int ---
	...
	* @return 0 on success, GIT_EEXISTS, GIT_EINVALIDSPEC or an error code
	*/
	git_reference_create :: proc(out: ^^git_reference, repo: ^git_repository, name: cstring, id: ^git_oid, force: c.int, log_message: cstring) -> c.int ---
	...
	*/
	git_reference_create_matching :: proc(out: ^^git_reference, repo: ^git_repository, name: cstring, id: ^git_oid, force: c.int, current_id: ^git_oid, log_message: cstring) -> c.int ---
	...
	* @return a pointer to the oid if available, NULL otherwise
	*/
	git_reference_target_peel :: proc(ref: ^git_reference) -> ^git_oid ---
	...
	*/
	git_reference_symbolic_target :: proc(ref: ^git_reference) -> cstring ---
	...
	* @return the type
	*/
	git_reference_type :: proc(ref: ^git_reference) -> git_reference_t ---
	...
	*/
	git_reference_owner :: proc(ref: ^git_reference) -> ^git_repository ---
	...
	*/
	git_reference_symbolic_set_target :: proc(out: ^^git_reference, ref: ^git_reference, target: cstring, log_message: cstring) -> c.int ---
	...
	*/
	git_reference_set_target :: proc(out: ^^git_reference, ref: ^git_reference, id: ^git_oid, log_message: cstring) -> c.int ---
	...
	*
	*/
	git_reference_rename :: proc(new_ref: ^^git_reference, ref: ^git_reference, new_name: cstring, force: c.int, log_message: cstring) -> c.int ---
	...
	*/
	git_reference_delete :: proc(ref: ^git_reference) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_reference_remove :: proc(repo: ^git_repository, name: cstring) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_reference_list :: proc(array: ^git_strarray, repo: ^git_repository) -> c.int ---
	...
	*/
	git_reference_foreach :: proc(repo: ^git_repository, callback: git_reference_foreach_cb, payload: rawptr) -> c.int ---
	...
	* @return 0 on success, non-zero callback return value, or error code
	*/
	git_reference_foreach_name :: proc(repo: ^git_repository, callback: git_reference_foreach_name_cb, payload: rawptr) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_reference_dup :: proc(dest: ^^git_reference, source: ^git_reference) -> c.int ---
	...
	*/
	git_reference_cmp :: proc(ref1: ^git_reference, ref2: ^git_reference) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_reference_iterator_new :: proc(out: ^^git_reference_iterator, repo: ^git_repository) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_reference_iterator_glob_new :: proc(out: ^^git_reference_iterator, repo: ^git_repository, glob: cstring) -> c.int ---
	...
	*/
	git_reference_next :: proc(out: ^^git_reference, iter: ^git_reference_iterator) -> c.int ---
	...
	* @return 0, GIT_ITEROVER if there are no more; or an error code
	*/
	git_reference_next_name :: proc(out: [^]cstring, iter: ^git_reference_iterator) -> c.int ---
	...
	*/
	git_reference_iterator_free :: proc(iter: ^git_reference_iterator) ---
	...
	*/
	git_reference_foreach_glob :: proc(repo: ^git_repository, glob: cstring, callback: git_reference_foreach_name_cb, payload: rawptr) -> c.int ---
	...
	*/
	git_reference_has_log :: proc(repo: ^git_repository, refname: cstring) -> c.int ---
	...
	* @return 0 or an error code.
	*/
	git_reference_ensure_log :: proc(repo: ^git_repository, refname: cstring) -> c.int ---
	...
	*/
	git_reference_is_branch :: proc(ref: ^git_reference) -> c.int ---
	...
	* namespace; 0 otherwise.
	*/
	git_reference_is_remote :: proc(ref: ^git_reference) -> c.int ---
	...
	* namespace; 0 otherwise.
	*/
	git_reference_is_tag :: proc(ref: ^git_reference) -> c.int ---
	...
	* namespace; 0 otherwise.
	*/
	git_reference_is_note :: proc(ref: ^git_reference) -> c.int ---
	...
	* or an error code.
	*/
	git_reference_normalize_name :: proc(buffer_out: cstring, buffer_size: c.int, name: cstring, flags: c.uint) -> c.int ---
	...
	*/
	git_reference_peel :: proc(out: ^^git_object, ref: ^git_reference, type: git_object_t) -> c.int ---
	...
	*/
	git_reference_name_is_valid :: proc(valid: ^c.int, refname: cstring) -> c.int ---
