...
foreign lib {
	...
	* @return 0 or an error code
	*/
	git_oid_fromstrp :: proc(out: ^git_oid, str: cstring) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_oid_fromstrn :: proc(out: ^git_oid, str: cstring, length: c.int) -> c.int ---
	...
	*/
	git_oid_fromraw :: proc(out: ^git_oid, raw: ^c.uchar) -> c.int ---
	...
	* @return 0 on success or error code
	*/
	git_oid_fmt :: proc(out: cstring, id: ^git_oid) -> c.int ---
	...
	* @return 0 on success or error code
	*/
	git_oid_nfmt :: proc(out: cstring, n: c.int, id: ^git_oid) -> c.int ---
	...
	*/
	git_oid_pathfmt :: proc(out: cstring, id: ^git_oid) -> c.int ---
	...
	*/
	git_oid_tostr :: proc(out: cstring, n: c.int, id: ^git_oid) -> cstring ---
	...
	* @return 0 on success or error code
	*/
	git_oid_cpy :: proc(out: ^git_oid, src: ^git_oid) -> c.int ---
	...
	*/
	git_oid_cmp :: proc(a: ^git_oid, b: ^git_oid) -> c.int ---
	...
	*/
	git_oid_equal :: proc(a: ^git_oid, b: ^git_oid) -> c.int ---
	...
	*/
	git_oid_ncmp :: proc(a: ^git_oid, b: ^git_oid, len: c.int) -> c.int ---
	...
	*/
	git_oid_streq :: proc(id: ^git_oid, str: cstring) -> c.int ---
	...
	*/
	git_oid_strcmp :: proc(id: ^git_oid, str: cstring) -> c.int ---
	...
	*/
	git_oid_is_zero :: proc(id: ^git_oid) -> c.int ---
	...
	*/
	git_oid_shorten_new :: proc(min_length: c.int) -> ^git_oid_shorten ---
	...
	*		error occurs.
	*/
	git_oid_shorten_add :: proc(os: ^git_oid_shorten, text_id: cstring) -> c.int ---
	...
	* @param os a `git_oid_shorten` instance
	*/
	git_oid_shorten_free :: proc(os: ^git_oid_shorten) ---
}
