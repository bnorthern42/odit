...
*/
git_submodule_status_t :: enum c.uint {
	IN_HEAD           = 1,
	IN_INDEX          = 2,
	IN_CONFIG         = 4,
	IN_WD             = 8,
...
*/
git_submodule_cb :: proc "c" (^git_submodule, cstring, rawptr) -> c.int
...
*
*/
git_submodule_update_options :: struct {
	version: c.uint,
...
GIT_SUBMODULE_UPDATE_OPTIONS_INIT :: {GIT_SUBMODULE_UPDATE_OPTIONS_VERSION, GIT_CHECKOUT_OPTIONS_INIT, GIT_FETCH_OPTIONS_INIT, 1}
...
foreign lib {
	...
	*/
	git_submodule_update_options_init :: proc(opts: ^git_submodule_update_options, version: c.uint) -> c.int ---
	...
	*/
	git_submodule_update :: proc(submodule: ^git_submodule, init: c.int, options: ^git_submodule_update_options) -> c.int ---
	...
	*         -1 on other errors.
	*/
	git_submodule_lookup :: proc(out: ^^git_submodule, repo: ^git_repository, name: cstring) -> c.int ---
	...
	* @return 0
	*/
	git_submodule_dup :: proc(out: ^^git_submodule, source: ^git_submodule) -> c.int ---
	...
	* @param submodule Submodule object
	*/
	git_submodule_free :: proc(submodule: ^git_submodule) ---
	...
	*/
	git_submodule_foreach :: proc(repo: ^git_repository, callback: git_submodule_cb, payload: rawptr) -> c.int ---
	...
	*         -1 on other errors.
	*/
	git_submodule_add_setup :: proc(out: ^^git_submodule, repo: ^git_repository, url: cstring, path: cstring, use_gitlink: c.int) -> c.int ---
	...
	*/
	git_submodule_clone :: proc(out: ^^git_repository, submodule: ^git_submodule, opts: ^git_submodule_update_options) -> c.int ---
	...
	*/
	git_submodule_add_finalize :: proc(submodule: ^git_submodule) -> c.int ---
	...
	*/
	git_submodule_add_to_index :: proc(submodule: ^git_submodule, write_index: c.int) -> c.int ---
	...
	*/
	git_submodule_owner :: proc(submodule: ^git_submodule) -> ^git_repository ---
	...
	*/
	git_submodule_name :: proc(submodule: ^git_submodule) -> cstring ---
	...
	*/
	git_submodule_path :: proc(submodule: ^git_submodule) -> cstring ---
	...
	*/
	git_submodule_url :: proc(submodule: ^git_submodule) -> cstring ---
	...
	* @return 0 or an error code
	*/
	git_submodule_resolve_url :: proc(out: ^git_buf, repo: ^git_repository, url: cstring) -> c.int ---
	...
	*/
	git_submodule_branch :: proc(submodule: ^git_submodule) -> cstring ---
	...
	* @return 0 on success, <0 on failure
	*/
	git_submodule_set_branch :: proc(repo: ^git_repository, name: cstring, branch: cstring) -> c.int ---
	...
	* @return 0 on success, <0 on failure
	*/
	git_submodule_set_url :: proc(repo: ^git_repository, name: cstring, url: cstring) -> c.int ---
	...
	*/
	git_submodule_index_id :: proc(submodule: ^git_submodule) -> ^git_oid ---
	...
	*/
	git_submodule_head_id :: proc(submodule: ^git_submodule) -> ^git_oid ---
	...
	*/
	git_submodule_wd_id :: proc(submodule: ^git_submodule) -> ^git_oid ---
	...
	*         this submodule.
	*/
	git_submodule_ignore :: proc(submodule: ^git_submodule) -> git_submodule_ignore_t ---
	...
	* @return 0 or an error code
	*/
	git_submodule_set_ignore :: proc(repo: ^git_repository, name: cstring, ignore: git_submodule_ignore_t) -> c.int ---
	...
	*         for this submodule.
	*/
	git_submodule_update_strategy :: proc(submodule: ^git_submodule) -> git_submodule_update_t ---
	...
	* @return 0 or an error code
	*/
	git_submodule_set_update :: proc(repo: ^git_repository, name: cstring, update: git_submodule_update_t) -> c.int ---
	...
	*/
	git_submodule_fetch_recurse_submodules :: proc(submodule: ^git_submodule) -> git_submodule_recurse_t ---
	...
	*/
	git_submodule_set_fetch_recurse_submodules :: proc(repo: ^git_repository, name: cstring, fetch_recurse_submodules: git_submodule_recurse_t) -> c.int ---
	...
	* @return 0 on success, <0 on failure.
	*/
	git_submodule_init :: proc(submodule: ^git_submodule, overwrite: c.int) -> c.int ---
	...
	* @return 0 on success, <0 on failure.
	*/
	git_submodule_repo_init :: proc(out: ^^git_repository, sm: ^git_submodule, use_gitlink: c.int) -> c.int ---
	...
	* @return 0 or an error code.
	*/
	git_submodule_sync :: proc(submodule: ^git_submodule) -> c.int ---
	...
	*/
	git_submodule_open :: proc(repo: ^^git_repository, submodule: ^git_submodule) -> c.int ---
	...
	*/
	git_submodule_reload :: proc(submodule: ^git_submodule, force: c.int) -> c.int ---
	...
	* @return 0 on success, <0 on error
	*/
	git_submodule_status :: proc(status: ^c.uint, repo: ^git_repository, name: cstring, ignore: git_submodule_ignore_t) -> c.int ---
	...
	* @return 0 on success, <0 on error
	*/
	git_submodule_location :: proc(location_status: ^c.uint, submodule: ^git_submodule) -> c.int ---
}
