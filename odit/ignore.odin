...
foreign lib {
	...
	* @return 0 on success
	*/
	git_ignore_add_rule :: proc(repo: ^git_repository, rules: cstring) -> c.int ---
	...
	* @return 0 on success
	*/
	git_ignore_clear_internal_rules :: proc(repo: ^git_repository) -> c.int ---
	...
	*/
	git_ignore_path_is_ignored :: proc(ignored: ^c.int, repo: ^git_repository, path: cstring) -> c.int ---
}
