...
foreign lib {
	...
	* @return 0, GIT_EINVALIDSPEC or an error code.
	*/
	git_branch_create_from_annotated :: proc(ref_out: ^^git_reference, repo: ^git_repository, branch_name: cstring, target: ^git_annotated_commit, force: c.int) -> c.int ---
	...
	*/
	git_branch_delete :: proc(branch: ^git_reference) -> c.int ---
	...
	* @return 0 on success  or an error code
	*/
	git_branch_iterator_new :: proc(out: ^^git_branch_iterator, repo: ^git_repository, list_flags: git_branch_t) -> c.int ---
	...
	*/
	git_branch_next :: proc(out: ^^git_reference, out_type: ^git_branch_t, iter: ^git_branch_iterator) -> c.int ---
	...
	*/
	git_branch_iterator_free :: proc(iter: ^git_branch_iterator) ---
	...
	*/
	git_branch_move :: proc(out: ^^git_reference, branch: ^git_reference, new_branch_name: cstring, force: c.int) -> c.int ---
	...
	*/
	git_branch_lookup :: proc(out: ^^git_reference, repo: ^git_repository, branch_name: cstring, branch_type: git_branch_t) -> c.int ---
	...
	*/
	git_branch_name :: proc(out: [^]cstring, ref: ^git_reference) -> c.int ---
	...
	*         or an error code
	*/
	git_branch_set_upstream :: proc(branch: ^git_reference, branch_name: cstring) -> c.int ---
	...
	*         or an error code.
	*/
	git_branch_upstream_name :: proc(out: ^git_buf, repo: ^git_repository, refname: cstring) -> c.int ---
	...
	* 		   as an error code.
	*/
	git_branch_is_head :: proc(branch: ^git_reference) -> c.int ---
	...
	*/
	git_branch_is_checked_out :: proc(branch: ^git_reference) -> c.int ---
	...
	*/
	git_branch_remote_name :: proc(out: ^git_buf, repo: ^git_repository, refname: cstring) -> c.int ---
	...
	*/
	git_branch_upstream_remote :: proc(buf: ^git_buf, repo: ^git_repository, refname: cstring) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_branch_upstream_merge :: proc(buf: ^git_buf, repo: ^git_repository, refname: cstring) -> c.int ---
	...
	* @return 0 on success or an error code
	*/
	git_branch_name_is_valid :: proc(valid: ^c.int, name: cstring) -> c.int ---
}
