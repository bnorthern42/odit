...
foreign lib {
	...
	*/
	git_object_lookup :: proc(object: ^^git_object, repo: ^git_repository, id: ^git_oid, type: git_object_t) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_object_lookup_prefix :: proc(object_out: ^^git_object, repo: ^git_repository, id: ^git_oid, len: c.int, type: git_object_t) -> c.int ---
	...
	*/
	git_object_lookup_bypath :: proc(out: ^^git_object, treeish: ^git_object, path: cstring, type: git_object_t) -> c.int ---
	...
	*/
	git_object_short_id :: proc(out: ^git_buf, obj: ^git_object) -> c.int ---
	...
	*/
	git_object_type :: proc(obj: ^git_object) -> git_object_t ---
	...
	*/
	git_object_owner :: proc(obj: ^git_object) -> ^git_repository ---
	...
	*/
	git_object_type2string :: proc(type: git_object_t) -> cstring ---
	...
	*/
	git_object_string2type :: proc(str: cstring) -> git_object_t ---
	...
	*/
	git_object_type_is_valid :: proc(type: git_object_t) -> c.int ---
	...
	*/
	git_object_peel :: proc(peeled: ^^git_object, object: ^git_object, target_type: git_object_t) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_object_dup :: proc(dest: ^^git_object, source: ^git_object) -> c.int ---
	...
	* @return 0 on success or an error code
	*/
	git_object_rawcontent_is_valid :: proc(valid: ^c.int, buf: cstring, len: c.int, object_type: git_object_t) -> c.int ---
}
