...
*/
git_remote_redirect_t :: enum c.uint {
	/**
...
*/
git_remote_create_flags :: enum c.uint {
...
*/
git_remote_update_flags :: enum c.uint {
...
*
*/
git_remote_create_options :: struct {
	version: c.uint,
...
* finished.
*/
git_remote_completion_t :: enum c.uint {
	DOWNLOAD,
	INDEXING,
	ERROR,
}
...
*/
git_push_transfer_progress_cb :: proc "c" (c.uint, c.uint, c.int, rawptr) -> c.int

/**
* Represents an update which will be performed on the remote during push
*/
git_push_update :: struct {
	/**
...
*/
git_push_negotiation :: proc "c" (^^git_push_update, c.int, rawptr) -> c.int
...
*/
git_push_update_reference_cb :: proc "c" (cstring, cstring, rawptr) -> c.int
...
*/
git_url_resolve_cb :: proc "c" (^git_buf, cstring, c.int, rawptr) -> c.int
...
*/
git_remote_ready_cb :: proc "c" (^git_remote, c.int, rawptr) -> c.int
...
git_remote_callbacks :: struct {
	...
	*/
	completion: proc "c" (git_remote_completion_t, rawptr) -> c.int,
	...
	* should be preferred
	*/
	update_tips: proc "c" (cstring, ^git_oid, ^git_oid, rawptr) -> c.int,
	...
	* structure.
	*/
	update_refs: proc "c" (cstring, ^git_oid, ^git_oid, ^git_refspec, rawptr) -> c.int,
}
...
*/
git_remote_autotag_option_t :: enum c.uint {
	/**
	* Use the setting from the configuration.
	*/
	UNSPECIFIED,
...
GIT_FETCH_OPTIONS_INIT :: {GIT_FETCH_OPTIONS_VERSION, GIT_REMOTE_CALLBACKS_INIT, GIT_FETCH_PRUNE_UNSPECIFIED, GIT_REMOTE_UPDATE_FETCHHEAD, GIT_REMOTE_DOWNLOAD_TAGS_UNSPECIFIED, GIT_PROXY_OPTIONS_INIT}
...
*
*/
git_remote_connect_options :: struct {}
...
GIT_REMOTE_CONNECT_OPTIONS_INIT :: {GIT_REMOTE_CONNECT_OPTIONS_VERSION, GIT_REMOTE_CALLBACKS_INIT, GIT_PROXY_OPTIONS_INIT}
...
foreign lib {
	...
	*/
	git_remote_create :: proc(out: ^^git_remote, repo: ^git_repository, name: cstring, url: cstring) -> c.int ---
	...
	*/
	git_remote_create_options_init :: proc(opts: ^git_remote_create_options, version: c.uint) -> c.int ---
	...
	* @return 0, GIT_EINVALIDSPEC, GIT_EEXISTS or an error code
	*/
	git_remote_create_with_opts :: proc(out: ^^git_remote, url: cstring, opts: ^git_remote_create_options) -> c.int ---
	...
	* @return 0, GIT_EINVALIDSPEC, GIT_EEXISTS or an error code
	*/
	git_remote_create_with_fetchspec :: proc(out: ^^git_remote, repo: ^git_repository, name: cstring, url: cstring, fetch: cstring) -> c.int ---
	...
	*/
	git_remote_create_anonymous :: proc(out: ^^git_remote, repo: ^git_repository, url: cstring) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_create_detached :: proc(out: ^^git_remote, url: cstring) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_dup :: proc(dest: ^^git_remote, source: ^git_remote) -> c.int ---
	...
	*/
	git_remote_owner :: proc(remote: ^git_remote) -> ^git_repository ---
	...
	*/
	git_remote_name :: proc(remote: ^git_remote) -> cstring ---
	...
	*/
	git_remote_pushurl :: proc(remote: ^git_remote) -> cstring ---
	...
	*/
	git_remote_set_url :: proc(repo: ^git_repository, remote: cstring, url: cstring) -> c.int ---
	...
	* @return 0, or an error code
	*/
	git_remote_set_pushurl :: proc(repo: ^git_repository, remote: cstring, url: cstring) -> c.int ---
	...
	* @return 0 or an error value
	*/
	git_remote_set_instance_url :: proc(remote: ^git_remote, url: cstring) -> c.int ---
	...
	* @return 0 or an error value
	*/
	git_remote_set_instance_pushurl :: proc(remote: ^git_remote, url: cstring) -> c.int ---
	...
	*/
	git_remote_add_fetch :: proc(repo: ^git_repository, remote: cstring, refspec: cstring) -> c.int ---
	...
	* @return 0 or an error code.
	*/
	git_remote_get_fetch_refspecs :: proc(array: ^git_strarray, remote: ^git_remote) -> c.int ---
	...
	* @return 0, GIT_EINVALIDSPEC if refspec is invalid or an error value
	*/
	git_remote_add_push :: proc(repo: ^git_repository, remote: cstring, refspec: cstring) -> c.int ---
	...
	* @return 0 or an error code.
	*/
	git_remote_get_push_refspecs :: proc(array: ^git_strarray, remote: ^git_remote) -> c.int ---
	...
	*/
	git_remote_refspec_count :: proc(remote: ^git_remote) -> c.int ---
	...
	*/
	git_remote_get_refspec :: proc(remote: ^git_remote, n: c.int) -> ^git_refspec ---
	...
	*/
	git_remote_ls :: proc(out: ^^^git_remote_head, size: ^c.int, remote: ^git_remote) -> c.int ---
	...
	*/
	git_remote_connected :: proc(remote: ^git_remote) -> c.int ---
	...
	* @return 0 on success, or an error code
	*/
	git_remote_stop :: proc(remote: ^git_remote) -> c.int ---
	...
	* @return Zero on success; -1 on failure.
	*/
	git_remote_init_callbacks :: proc(opts: ^git_remote_callbacks, version: c.uint) -> c.int ---
	...
	* @return Zero on success; -1 on failure.
	*/
	git_remote_connect_options_init :: proc(opts: ^git_remote_connect_options, version: c.uint) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_connect :: proc(remote: ^git_remote, direction: git_direction, callbacks: ^git_remote_callbacks, proxy_opts: ^git_proxy_options, custom_headers: ^git_strarray) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_connect_ext :: proc(remote: ^git_remote, direction: git_direction, opts: ^git_remote_connect_options) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_download :: proc(remote: ^git_remote, refspecs: ^git_strarray, opts: ^git_fetch_options) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_upload :: proc(remote: ^git_remote, refspecs: ^git_strarray, opts: ^git_push_options) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_update_tips :: proc(remote: ^git_remote, callbacks: ^git_remote_callbacks, update_flags: c.uint, download_tags: git_remote_autotag_option_t, reflog_message: cstring) -> c.int ---
	...
	* @return 0 or an error code
	*/
	git_remote_prune :: proc(remote: ^git_remote, callbacks: ^git_remote_callbacks) -> c.int ---
	...
	*/
	git_remote_stats :: proc(remote: ^git_remote) -> ^git_indexer_progress ---
	...
	*/
	git_remote_autotag :: proc(remote: ^git_remote) -> git_remote_autotag_option_t ---
	...
	* @return 0, or an error code.
	*/
	git_remote_set_autotag :: proc(repo: ^git_repository, remote: cstring, value: git_remote_autotag_option_t) -> c.int ---
	...
	*/
	git_remote_prune_refs :: proc(remote: ^git_remote) -> c.int ---
	...
	* @return 0, GIT_EINVALIDSPEC, GIT_EEXISTS or an error code
	*/
	git_remote_rename :: proc(problems: ^git_strarray, repo: ^git_repository, name: cstring, new_name: cstring) -> c.int ---
	...
	* @return 0 on success or an error code
	*/
	git_remote_name_is_valid :: proc(valid: ^c.int, remote_name: cstring) -> c.int ---
