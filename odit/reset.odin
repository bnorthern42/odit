...
// INCLUDE_git_reset_h__ :: 

/**
* Kinds of reset operation
*/
git_reset_t :: enum c.uint {
...
foreign lib {
	...
	* @return 0 on success or an error code
	*/
	git_reset_from_annotated :: proc(repo: ^git_repository, target: ^git_annotated_commit, reset_type: git_reset_t, checkout_opts: ^git_checkout_options) -> c.int ---
	...
	*/
	git_reset_default :: proc(repo: ^git_repository, target: ^git_object, pathspecs: ^git_strarray) -> c.int ---
}
